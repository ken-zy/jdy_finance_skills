...
- ✅ Consensus estimates source (with date)
...
Create 8-12 page report with specific structure.
...
**Primary Deliverable**: Report (8-12 pages)
**File Name**: `[Company]_Q[Quarter]_[Year]_Earnings_Update`
**Example**: `Nike_Q2_FY24_Earnings_Update`
